                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 p-md-5 p-sm-4 p-3">
                                <form action="{{ route('resumes.update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="email" id="email" name="email" placeholder="Email" class="form-control"
                                value="{{ $information['contact_info']->email ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="number" id="phone_number" name="phone_number" placeholder="Phone Number"
                                class="form-control"
                                value="{{ $information['contact_info']->phone_number ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="url" id="website" name="website" class="form-control" placeholder="Website"
                                value="{{ $information['contact_info']->website ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                        <div class="form-outline">
                            <label class="form-label fw-bold text-secondary">LinkedIn</label>
                            <input type="url" id="linkedin_link" name="linkedin_link" class="form-control"
                                placeholder="LinkedIn"
                                value="{{ $information['contact_info']->linkedin_link ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="url" id="github_link" name="github_link" class="form-control"
                                placeholder="Github"
                                value="{{ $information['contact_info']->github_link ?? '' }}" />
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="text" id="twitter" name="twitter" class="form-control" placeholder="Twitter"
                                value="{{ $information['contact_info']->twitter ?? '' }}" />
                        </div>
                    </div>
                </div>
            </div>
