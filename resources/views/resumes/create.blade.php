...
<div class="content-wrapper mt-4">
    ...
    <div class="col-12">
        ...
        <div class="form-outline mb-4">
            <input type="hidden" name="personal_information[user_id]" class="form-control" />
        </div>
        ...
        <div class="row mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" name="personal_information[first_name]" placeholder="First name" class="form-control" required />
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-outline">
                            ...
                            <input type="text" name="personal_information[last_name]" placeholder="Last name" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-12">
                ...
                <div class="profile_picture text-center">
                    <input type="file" name="personal_information[image_path]" accept="image/png, image/jpeg, image/jpg" onchange="display_image(this);" class="d-none upload-box-image">
        ...
        <!-- Profile Title -->
        <div class="form-outline mb-4">
            <label class="form-label fw-bold text-secondary">Profile Title</label>
            <input type="text" name="personal_information[profile_title]" class="form-control" placeholder="Profile Title" required />
        </div>

        <!-- About Me -->
        <div class="form-outline mb-4">
            <label class="form-label fw-bold text-secondary">About</label>
            <textarea class="form-control" placeholder="Description" name="personal_information[about_me]" rows="4"></textarea>
        </div>
    </div>
</div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="form-outline">
                    ...
                    <input type="email" name="contact_information[email]" placeholder="Email" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="form-outline">
                    ...
                    <input type="text" name="contact_information[phone]" placeholder="Phone Number" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="form-outline">
                    ...
                    <input type="url" name="contact_information[website]" placeholder="Website" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="form-outline">
                    <label class="form-label fw-bold text-secondary">LinkedIn</label>
                    <input type="url" name="contact_information[linkedin]" placeholder="LinkedIn" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="form-outline">
                    ...
                    <input type="url" name="contact_information[github]" placeholder="Github" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="form-outline">
                    ...
                    <input type="text" name="contact_information[twitter]" placeholder="Twitter" class="form-control" />
                </div>
            </div>
        </div>
    </div>
